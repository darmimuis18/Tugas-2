...
$status = curl_get("https://simak.poliupg.ac.id/api/machine/get_tabel_konten/bri_mhs_aktif/thn_ajar/20201/kode_prodi/425/kelas/3c/jk/P");
...
// }
file_put_contents("test.txt",json_encode($arMhs));
